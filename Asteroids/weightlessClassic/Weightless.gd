...
func _init():
	...
	bangLarge.stream = load("res://soundsClassic/bangLargeClassic.wav")
	
	bangMedium = AudioStreamPlayer.new()
	self.add_child(bangMedium)
	bangMedium.stream = load("res://soundsClassic/bangMediumClassic.wav")
	
	bangSmall = AudioStreamPlayer.new()
	self.add_child(bangSmall)
	bangSmall.stream = load("res://soundsClassic/bangSmallClassic.wav")
